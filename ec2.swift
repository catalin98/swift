...
func calculeaza (a:Float,b:Float,c:Float,x1_re:inout Float, x2_re:inout Float, x1_im:inout Float, x2_im:inout Float) {
...
func tipareste (x1_re : Float, x2_re : Float, x1_im : Float, x2_im : Float) {
...
x2_im=0
citeste (a:&a,b:&b,c:&c)
calculeaza(a:a,b:b,c:c,x1_re:&x1_re,x2_re:&x2_re,x1_im:&x1_im,x2_im : &x2_im)
